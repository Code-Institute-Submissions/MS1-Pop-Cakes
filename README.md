...
-   ###    User Stories
    ...
    -   ####        First Time Visitor Goals
        ...
        1.    -  As a First Time Visitor, I want to easily see the available design shapes and how to order
        2.    -  As a First Time Visitor, I want to be able to easily navigate throughout the site to find content.
        3.    -  As a First Time Visitor, I want to know if there are different flavours.
        4.    -  As a First Time Visitor, I also want to connect with the business on social media links.

    -   ####    Returning Visitor Goals

        1.    -  As a Returning Visitor, I want to find see new designs
        2.    -  As a Returning Visitor, I want to be able to contact the business to place orders
        3.    -  As a Returning Visitor, I want to find social media links.

    -   ####    Frequent User Goals

        1.    -  As a Frequent User, I want to check to see if there are any seasonal designs.
